...
class DataProcessingSchedule(models.Model):
    _description = 'Data Processing Schedule'
    _name = 'clv.data_processing.schedule'
    _order = 'name'

    template_id = fields.Many2one(
        comodel_name='clv.data_processing.template',
        string='Data Processing Template',
        required=False,
        ondelete='restrict'
    )
    ...
    name = fields.Char(
        string='Name',
        required=True,
        help='Data Processing Schedule Name'
    )
...
class DataProcessingTemplate(models.Model):
    _inherit = 'clv.data_processing.template'

    schedule_ids = fields.One2many(
        comodel_name='clv.data_processing.schedule',
