...
class EmployeeMngUpdate(models.TransientModel):
    ...
    global_tag_ids = fields.Many2many(
        ...
        relation='clv_employee_mng_updt_global_tag_rel',
        column1='employee_id',
    ...
    #     Employee = self.env['clv.employee.mng']
    #     employees = Employee.search([])

    #     self.employee.mng_ids = employees
