...
class Tag(models.Model):
    ...
    lab_test_request_ids = fields.Many2many(
        ...
        relation='clv_lab_test_request_global_tag_rel',
        column1='global_tag_id',
        column2='lab_test_request_id',
    ...
    lab_test_report_ids = fields.Many2many(
        ...
        relation='clv_lab_test_report_global_tag_rel',
        column1='global_tag_id',
        column2='lab_test_report_id',
...
class LabTestResult(models.Model):
    ...
    def _compute_global_tag_names_suport(self):
        for r in self:
            ...
            r.global_tag_names_suport = global_tag_names
            if r.global_tag_names != global_tag_names:
                record = self.env['clv.lab_test.result'].search([('id', '=', r.id)])
                record.write({'global_tag_ids': r.global_tag_ids})
...
class LabTestReport(models.Model):
    ...
    def _compute_global_tag_names_suport(self):
        for r in self:
            ...
            r.global_tag_names_suport = global_tag_names
            if r.global_tag_names != global_tag_names:
                record = self.env['clv.lab_test.report'].search([('id', '=', r.id)])
                record.write({'global_tag_ids': r.global_tag_ids})
