...
class CommunityUpdate(models.TransientModel):
    _name = 'clv.community.updt'

    def _default_community_ids(self):
        return self._context.get('active_ids')
    community_ids = fields.Many2many(
        comodel_name='clv.community',
        relation='clv_community_updt_rel',
        string='Communities',
        default=_default_community_ids
    )

    global_tag_ids = fields.Many2many(
        comodel_name='clv.global_tag',
        relation='clv_community_updt_global_tag_rel',
    ...
    category_ids = fields.Many2many(
        ...
        relation='clv_community_updt_category_rel',
        column1='community_id',
        column2='category_id',
        string='Categories'
    )
    ...
    def do_community_updt(self):
        ...
        for community in self.community_ids:
            ...
            if self.global_tag_ids_selection == 'add':
                ...
                community.global_tag_ids = m2m_list
            ...
            if self.global_tag_ids_selection == 'set':
                m2m_list = []
                for global_tag_id in community.global_tag_ids:
                    m2m_list.append((3, global_tag_id.id))
                _logger.info(u'%s %s', '>>>>>>>>>>', m2m_list)
                community.global_tag_ids = m2m_list
                m2m_list = []
            ...
            if self.category_ids_selection == 'add':
                ...
                _logger.info(u'%s %s', '>>>>>>>>>>', m2m_list)
                community.category_ids = m2m_list
