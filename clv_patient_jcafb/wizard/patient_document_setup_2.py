...
class PatientDocumentSetUp_2(models.TransientModel):
    _description = 'Patient Document Setup 2'
    _name = 'clv.patient.document_setup_2'

    def _default_patient_ids(self):
        return self._context.get('active_ids')
    patient_ids = fields.Many2many(
        comodel_name='clv.patient',
        relation='clv_patient_document_setup_2_rel',
        string='Patients',
    ...
    #     relation='clv_patient_document_setup_2_document_type_rel',
    ...
    def do_patient_document_setup_2(self):
        self.ensure_one()
