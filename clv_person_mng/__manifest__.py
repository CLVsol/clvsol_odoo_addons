...
{
    'name': 'Person Management (for CLVhealth-JCAFB Solution)',
    'summary': 'Person Management Module for CLVhealth-JCAFB Solution.',
    'version': '3.0.0',
    ...
    'data': [
        ...
        'wizard/person_mng_adapt_view.xml',
        'wizard/person_mng_person_confirm_view.xml',
        'wizard/person_mng_address_confirm_view.xml',
        'wizard/person_mng_get_related_address_view.xml',
        'wizard/person_mng_person_update_view.xml',
        'wizard/person_mng_person_search_view.xml',
        ...
        'wizard/person_mng_update_data_view.xml',
    ],
    'demo': [],
    'test': [],
    'init_xml': [],
