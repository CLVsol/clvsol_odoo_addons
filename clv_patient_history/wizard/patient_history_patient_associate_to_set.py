...
class PatientHistoryPatientAssociateToSet(models.TransientModel):
    _description = 'Patient History Associate to Set (Patient)'
    _name = 'clv.patient.history.patient_associate_to_set'

    def _default_patient_history_ids(self):
        return self._context.get('active_ids')
    patient_history_ids = fields.Many2many(
        comodel_name='clv.patient.history',
        relation='clv_patient_history_patient_associate_to_set_rel',
    ...
    def do_patient_history_patient_associate_to_set(self):
        self.ensure_one()
