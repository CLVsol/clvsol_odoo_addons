...
class AddressMassEdit(models.TransientModel):
    ...
    category_ids = fields.Many2many(
        ...
        relation='clv_address_mass_edit_category_rel',
        column1='address_id',
        column2='category_id',
        string='Categories'
    )
    ...
    marker_ids = fields.Many2many(
        ...
        relation='clv_address_mass_edit_marker_rel',
        column1='address_id',
        column2='marker_id',
        string='Markers'
    )
