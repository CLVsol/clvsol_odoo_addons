...
class SummaryUpdate(models.TransientModel):
    _name = 'clv.summary.updt'

    def _default_summary_ids(self):
        return self._context.get('active_ids')
    summary_ids = fields.Many2many(
        comodel_name='clv.summary',
        relation='clv_summary_updt_rel',
        string='Summaries',
    ...
    global_tag_ids = fields.Many2many(
        ...
        relation='clv_summary_updt_global_tag_rel',
        column1='summary_id',
    ...
    category_ids = fields.Many2many(
        comodel_name='clv.summary.category',
        relation='clv_summary_updt_category_rel',
        column1='summary_id',
        column2='category_id',
        string='Categories'
    )
    ...
    def do_summary_updt(self):
        ...
        for summary in self.summary_ids:
            ...
            if self.global_tag_ids_selection == 'add':
                ...
                summary.global_tag_ids = m2m_list
            ...
            if self.global_tag_ids_selection == 'set':
                m2m_list = []
                for global_tag_id in summary.global_tag_ids:
                    m2m_list.append((3, global_tag_id.id))
                _logger.info(u'%s %s', '>>>>>>>>>>', m2m_list)
                summary.global_tag_ids = m2m_list
                m2m_list = []
