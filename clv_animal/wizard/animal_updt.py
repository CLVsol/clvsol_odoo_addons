...
class AnimalUpdate(models.TransientModel):
    ...
    global_tag_ids = fields.Many2many(
        ...
        relation='clv_animal_updt_global_tag_rel',
        column1='animal_id',
    ...
    category_ids = fields.Many2many(
        ...
        relation='clv_animal_updt_category_rel',
        column1='animal_id',
        column2='category_id',
        string='Categories'
    )
    ...
    def do_animal_updt(self):
        ...
        for animal in self.animal_ids:
            ...
            if self.global_tag_ids_selection == 'add':
                ...
                animal.global_tag_ids = m2m_list
            ...
            if self.global_tag_ids_selection == 'set':
                m2m_list = []
                for global_tag_id in animal.global_tag_ids:
                    m2m_list.append((3, global_tag_id.id))
                _logger.info(u'%s %s', '>>>>>>>>>>', m2m_list)
                animal.global_tag_ids = m2m_list
                m2m_list = []
