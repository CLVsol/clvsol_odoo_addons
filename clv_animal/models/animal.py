...
class Animal(models.Model):
    ...
    #     help='Animal Identifier provided by the Health Center.'
    ...
    #     help='Check this if the animal if pregnant',
    # )
    ...
    def _create_vals(self, vals):
        vals = super(Animal, self)._create_vals(vals)
    ...
    def _get_default_image_path(self, vals):
        res = super(Animal, self)._get_default_image_path(vals)
        if res:
            return res
        image_path = get_module_resource(
            'clv_animal', 'static/src/img', 'animal-avatar.png',
        )
        return image_path
