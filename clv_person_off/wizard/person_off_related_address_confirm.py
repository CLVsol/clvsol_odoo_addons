...
class PersonOffRelatedAddressConfirm(models.TransientModel):
    _name = 'clv.person.off.related_address_confirm'

    def _default_person_off_ids(self):
        return self._context.get('active_ids')
    person_off_ids = fields.Many2many(
        comodel_name='clv.person.off',
        relation='clv_person_off_related_address_confirm_rel',
        string='Persons (Off)',
    ...
    @api.multi
    def do_person_off_related_address_confirm(self):
        self.ensure_one()
        ...
        for person_off in self.person_off_ids:
            ...
            if person_off.address_id.id is False:
                ...
                person_off.address_id = person_off.person_id.address_id.id
