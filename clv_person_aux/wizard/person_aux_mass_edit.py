...
class PersonAuxMassEdit(models.TransientModel):
    ...
    global_tag_ids = fields.Many2many(
        ...
        relation='clv_person_aux_mass_edit_global_tag_rel',
    ...
    category_ids = fields.Many2many(
        ...
        relation='clv_person_aux_mass_edit_category_rel',
        column1='person_aux_id',
        column2='category_id',
        string='Categories'
    )
    ...
    marker_ids = fields.Many2many(
        ...
        relation='clv_person_aux_mass_edit_marker_rel',
        column1='person_aux_id',
        column2='marker_id',
        string='Markers'
    )
    ...
    def do_person_aux_mass_edit(self):
        ...
        for person_aux in self.person_aux_ids:
            ...
            if self.global_tag_ids_selection == 'add':
                ...
                person_aux.global_tag_ids = m2m_list
            ...
            if self.category_ids_selection == 'add':
                ...
                _logger.info(u'%s %s', '>>>>>>>>>>', m2m_list)
                person_aux.category_ids = m2m_list
            ...
            if self.category_ids_selection == 'set':
                m2m_list = []
                for category_id in person_aux.category_ids:
                    m2m_list.append((3, category_id.id))
                _logger.info(u'%s %s', '>>>>>>>>>>', m2m_list)
                person_aux.category_ids = m2m_list
                m2m_list = []
            ...
            if self.marker_ids_selection == 'set':
                m2m_list = []
                for marker_id in person_aux.marker_ids:
                    m2m_list.append((3, marker_id.id))
                _logger.info(u'%s %s', '>>>>>>>>>>', m2m_list)
                person_aux.marker_ids = m2m_list
                m2m_list = []
